# OpenCode Conductor Bridge (v1.1.13)
...
```bash
BRIDGE_REF=v1.1.13 npx github:bardusco/opencode-conductor-bridge
```
...
1. **Supply Chain:** By default, the installer uses the latest stable tag (e.g., `v1.1.13`). Use `BRIDGE_REF` to pin to a specific SHA for production environments.
