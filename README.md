...
```bash
BRIDGE_REF=v1.2.1 npx github:bardusco/opencode-conductor-bridge
```
...
1. **Supply Chain:** By default, the installer uses the latest stable tag (e.g., `v1.2.1`). Use `BRIDGE_REF` to pin to a specific SHA for production environments.
...
| :--- | :--- | :--- | :--- |
| **v1.2.1** | [b49d770](https://github.com/gemini-cli-extensions/conductor/commit/b49d770) | >= 1.0.0 | ✅ Stable |
