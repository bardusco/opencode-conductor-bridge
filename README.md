# OpenCode Conductor Bridge (v1.1.2)
...
```bash
# Windows/Node
$env:BRIDGE_REF="v1.1.2"; npx github:bardusco/opencode-conductor-bridge

# macOS/Linux
BRIDGE_REF=v1.1.2 curl -sSL https://raw.githubusercontent.com/bardusco/opencode-conductor-bridge/main/install.sh | bash
```
...
1. **Supply Chain:** By default, the installer uses the latest stable tag (e.g., `v1.1.2`). Use `BRIDGE_REF` to pin to a specific SHA for production environments.
...
| :--- | :--- | :--- | :--- |
| **v1.1.2** | [b49d770](https://github.com/gemini-cli-extensions/conductor/commit/b49d770) | >= 1.0.0 | ✅ Stable |
